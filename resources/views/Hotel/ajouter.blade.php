...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" >
        <div class="row">
            <div class="col s12">
                <h1>Ajouter les informations de l'hotel </h1>
                <hr>
                ...
                <form  action="/ajouter/traitement" method="POST" class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Nom_de_lHotel"  name="Nom_de_lHotel"> 

                    </div>

                    <div class="form-group">
                        <label for="description_de_lHotel" class="form-label">Description de l'hotel</label>
                        <input type="text" class="form-control" id="description_de_lHotel"  name="description_de_lHotel">   
                    </div>

                    <div class="form-group">
                        <label for="nom_de_la_chambre" class="form-label">Nom de la chambre</label>
                        <input type="text" class="form-control" id="nom_de_la_chambre"  name="nom_de_la_chambre">   
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Nombre_de_lits"  name="Nombre_de_lits">   
                    </div>

                    <div class="form-group">
                        <label for="max_dadultes" class="form-label">Max d'adultes</label>
                        <input type="text" class="form-control" id="max_dadultes"  name="max_dadultes">   
                    </div>

                    <div class="form-group">
                        <label for="Enfants_maximum_autorisé" class="form-label">Enfants maximum autorisé</label>
                        <input type="text" class="form-control" id="Enfants_maximum_autorisé"  name="Enfants_maximum_autorisé">   
                    </div>


                    <div class="form-group">
                        <label for="Attributs" class="form-label">Attributs</label>
                        <select name="Attributs" id="Attributs"  class="form-control multiple-task" >
                    ...
                    <div class="form-group">
                        ...
                        <select name="Status" id="Status"  class="form-control multiple-task">
